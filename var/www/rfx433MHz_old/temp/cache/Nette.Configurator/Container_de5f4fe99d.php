<?php
// source: /var/www/rfx433MHz/app/config/config.neon 
// source: /var/www/rfx433MHz/app/config/config.local.neon 

class Container_de5f4fe99d extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\HelpPresenter' => array(array('application.3')),
		...
		'services' => array(
			...
			'application.3' => 'App\Presenters\HelpPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/rfx433MHz/app',
			'wwwDir' => '/var/www/rfx433MHz/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/var/www/rfx433MHz/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/var/www/rfx433MHz/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/rfx433MHz/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/rfx433MHz/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_de5f4fe99d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/var/www/rfx433MHz/app/../temp/cache/latte');
...
final class Container_de5f4fe99d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_de5f4fe99d $container)
	{
