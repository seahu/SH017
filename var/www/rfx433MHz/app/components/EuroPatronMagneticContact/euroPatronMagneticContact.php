...
class EuroPatronMagneticContact extends domoticzControl
{
	...
	public function renderControl()
	{
		...
		// vyber sablony
		$this->template->setFile(__DIR__.'/euroPatronMagneticContact.latte');
		//vykreslneni
	...
	public function renderScanRFXCode()
	{
		...
		$this->template->setFile(__DIR__.'/euroPatronMagneticContact_scanCode.latte');
	}
	...
	{
		$this->template->setFile(__DIR__.'/euroPatronMagneticContact_Rename.latte'); // vybere sablonu kde se do ktere se vklda pres tovarnicku formular vyse
	}
