<?php
// source: /var/www/rfx433MHz/app/components/EuroPatronPanicButton/euroPatronPanicButton_Rename.latte

class Template96d98ac527c46caefc35124d59b54841 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('746257a109', 'html')
;
