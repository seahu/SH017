<?php
// source: /var/www/rfx433MHz/app/components/generalOnOffSwitch/generalOnOffSwitch.latte

class Templatef9e37126c7bba0cf3d15cf1b19c996f6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b2eb7693ce', 'html')
;
