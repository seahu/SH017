<?php
// source: /var/www/rfx433MHz/app/components/EuroPatronMagneticContact/euroPatronMagneticContact.latte

class Template2b2639351bd749b593a36d9ab331def0 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1d855b7ffc', 'html')
;
