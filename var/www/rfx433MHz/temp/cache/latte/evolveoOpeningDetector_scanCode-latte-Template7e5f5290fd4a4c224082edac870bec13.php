<?php
// source: /var/www/rfx433MHz/app/components/evolveoOpeningDetector/evolveoOpeningDetector_scanCode.latte

class Template7e5f5290fd4a4c224082edac870bec13 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('366a1db76d', 'html')
;
...
"> Start scan</a><br>
						actual code:<br>
						<?php echo Latte\Runtime\Filters::escapeHtml($config->familyCode, ENT_NOQUOTES) ?>
