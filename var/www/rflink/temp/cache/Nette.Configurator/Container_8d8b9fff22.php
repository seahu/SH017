...
class Container_8d8b9fff22 extends Nette\DI\Container
{
	...
	{
		return new Container_8d8b9fff22_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_8d8b9fff22_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_8d8b9fff22 $container)
	{
