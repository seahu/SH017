<?php
// source: /var/www/ser2net/app/presenters/templates/@layout.latte

class Template8359523388083b8fc3f5e2dd8d4553ab extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('978ba7d991', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb91fa1749c3_head')) { function _lb91fa1749c3_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb5ccd3173c3_scripts')) { function _lb5ccd3173c3_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
