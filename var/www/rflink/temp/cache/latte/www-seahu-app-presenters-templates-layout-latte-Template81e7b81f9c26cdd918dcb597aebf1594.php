<?php
// source: /var/www/seahu/app/presenters/templates/@layout.latte

class Template81e7b81f9c26cdd918dcb597aebf1594 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2c6838518a', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb90b0122aac_head')) { function _lb90b0122aac_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb336b449374_scripts')) { function _lb336b449374_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php if ($user->loggedIn) { ?>
			<a class="mybutton" href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("Sign:change"), ENT_COMPAT) ?>
">Change passwd</a><br>
			<a class="mybutton" href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("Power:"), ENT_COMPAT) ?>
">Power</a><br>
			<a class="mybutton" href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("Terminal:"), ENT_COMPAT) ?>
">Terminal</a><br>
<?php } ?>
		<a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("Servicies:"), ENT_COMPAT) ?>" class="mybutton">Services</a><br>
		<a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("Help:"), ENT_COMPAT) ?>" class="mybutton">Help</a><br>
		<a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("Ser2net:"), ENT_COMPAT) ?>" class="mybutton">Ser2net</a><br>
	</div>
	<div class="content">
