<?php
// source: /opt/seahu/www/seahu/app/config/config.neon 
// source: /opt/seahu/www/seahu/app/config/config.local.neon 

class Container_d1747076cd extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\HwPresenter' => array(array('application.8')),
			'App\Presenters\HomepagePresenter' => array(array('application.9')),
			'App\Presenters\SignPresenter' => array(array('application.10')),
			'App\Presenters\ServiciesPresenter' => array(array('application.11')),
		...
		'services' => array(
			...
			'application.11' => 'App\Presenters\ServiciesPresenter',
			...
			'application.8' => 'App\Presenters\HwPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/opt/seahu/www/seahu/app',
			'wwwDir' => '/opt/seahu/www/seahu/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/opt/seahu/www/seahu/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/opt/seahu/www/seahu/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/opt/seahu/www/seahu/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/opt/seahu/www/seahu/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_d1747076cd_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/opt/seahu/www/seahu/app/../temp/cache/latte');
...
final class Container_d1747076cd_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_d1747076cd $container)
	{
