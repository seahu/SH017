<?php
// source: /var/www/ser2net/app/presenters/templates/Ser2net/deleteQuery.latte

class Templatef6900ef43e50545cd448000d52948fc8 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1d153ec61f', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb62fa5b51a3_content')) { function _lb62fa5b51a3_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="ser2net">
