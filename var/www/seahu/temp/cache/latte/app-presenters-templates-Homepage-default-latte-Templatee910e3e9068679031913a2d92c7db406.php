<?php
// source: /opt/seahu/www/seahu/app/presenters/templates/Homepage/default.latte

class Templatee910e3e9068679031913a2d92c7db406 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b78a4cf34d', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb27bc4a3745_content')) { function _lb27bc4a3745_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;if ($emptny==true) { ?>
