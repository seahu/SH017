...
/images/en.png"><image src="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>/images/cz.png">
			...
			<h2><a href="../../help/serial_port_to_net" class="help">Serial port to net</a></h2>
			<a href="../../help/serial_port_to_net/cz.Seahu_SH017_seriova_komunikace.pdf" class="mybutton">
				Sériová komunikace
				<image src="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>/images/cz.png">
			</a><br>

			<h2><a href="../../help/RFX433MHz" class="help">RFX 433MHz</a></h2>
			<a href="../../help/RFX433MHz/cz.Seahu_SH017_rfx433MHz.pdf" class="mybutton">
				RFX 433MHz obecně
				<image src="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>/images/cz.png">
			</a><br>

			<h2><a href="../../help/rflink" class="help">RFLink 433MHz</a></h2>
			<a href="../../help/rflink/cz.Seahu_SH017_rflink.pdf" class="mybutton">
				RFLink nejen pro SEAHU SH017
				<image src="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>/images/cz.png">
			</a><br>
