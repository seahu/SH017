<?php
// source: /var/www/seahu/app/config/config.neon 
// source: /var/www/seahu/app/config/config.local.neon 

class Container_a4ef23eba0 extends Nette\DI\Container
{
		...
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'security.user',
					'session.session',
					'25_App_Forms_ChangeFormFactory',
			...
			'App\Forms\ChangeFormFactory' => array(
				1 => array('25_App_Forms_ChangeFormFactory'),
			),
			...
			'App\Presenters\PowerPresenter' => array(array('application.5')),
			'App\Presenters\TerminalPresenter' => array(array('application.6')),
			'App\Presenters\TimePresenter' => array(array('application.7')),
			'App\Presenters\HelpPresenter' => array(array('application.8')),
			'App\Presenters\HwPresenter' => array(array('application.9')),
			'App\Presenters\HomepagePresenter' => array(array('application.10')),
			'App\Presenters\SignPresenter' => array(array('application.11')),
			'App\Presenters\ModemPresenter' => array(array('application.12')),
			'App\Presenters\ServiciesPresenter' => array(array('application.13')),
			'NetteModule\ErrorPresenter' => array(array('application.14')),
			'NetteModule\MicroPresenter' => array(array('application.15')),
			'Nette\DI\Container' => array(1 => array('container')),
		),
		'services' => array(
			'25_App_Forms_ChangeFormFactory' => 'App\Forms\ChangeFormFactory',
			...
			'application.10' => 'App\Presenters\HomepagePresenter',
			'application.11' => 'App\Presenters\SignPresenter',
			'application.12' => 'App\Presenters\ModemPresenter',
			'application.13' => 'App\Presenters\ServiciesPresenter',
			...
			'application.5' => 'App\Presenters\PowerPresenter',
			'application.6' => 'App\Presenters\TerminalPresenter',
			'application.7' => 'App\Presenters\TimePresenter',
			'application.8' => 'App\Presenters\HelpPresenter',
			'application.9' => 'App\Presenters\HwPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/seahu/app',
			'wwwDir' => '/var/www/seahu/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/var/www/seahu/app/../temp',
		));
	}


	/**
	 * @return App\Forms\ChangeFormFactory
	 */
	public function createService__25_App_Forms_ChangeFormFactory()
	{
		$service = new App\Forms\ChangeFormFactory($this->getService('26_App_Forms_FormFactory'), $this->getService('security.user'));
		return $service;
	}
	...
	/**
	 * @return App\Presenters\WifiPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\WifiPresenter;
	...
	public function createServiceApplication__11()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->factory1 = $this->getService('25_App_Forms_ChangeFormFactory');
	...
	/**
	 * @return App\Presenters\NetPresenter
	 */
	public function createServiceApplication__2()
	{
		$service = new App\Presenters\NetPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/var/www/seahu/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/seahu/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/seahu/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_a4ef23eba0_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/var/www/seahu/app/../temp/cache/latte');
...
final class Container_a4ef23eba0_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_a4ef23eba0 $container)
	{
