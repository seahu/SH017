...
Update() {
    ...
    echo -e "usernname\npasswd" >  /home/pi/SH017/etc/openvpn/auth.txt
    echo -e "-----BEGIN CERTIFICATE-----\n-----END CERTIFICATE-----" >  /home/pi/SH017/etc/openvpn/ca.crt
    echo -e "remote your.addr.com\nclient\ndev tun\n#link-mtu 1200\ncipher BF-CBC\ncomp-lzo yes\nca ca.crt\nauth-user-pass auth.txt\ntls-version-min 1.0" > /home/pi/SH017/etc/openvpn/openvpn.conf
    #ser2net
